...
type Sessions interface {
	Create(r *http.Request, userID uuid.UUID, token string, deviceData json.RawMessage) error
...
func (s *sessions) Create(r *http.Request, userID uuid.UUID, token string, deviceData json.RawMessage) error {
