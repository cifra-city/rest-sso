...
type EmailData struct {
	...
	Attributes EmailDataAttributes `json:"attributes"`
}

type _EmailData EmailData
...
func (o *EmailData) UnmarshalJSON(data []byte) (err error) {
	...
	varEmailData := _EmailData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEmailData)

	if err != nil {
		return err
	}

	*o = EmailData(varEmailData)
