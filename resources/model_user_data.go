...
func NewUserData(data UserDataData) *UserData {
	this := UserData{}
	this.Data = data
	return &this
}
...
func (o *UserData) GetData() UserDataData {
	if o == nil {
		var ret UserDataData
		return ret
	}
...
func (o *UserData) GetDataOk() (*UserDataData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *UserData) SetData(v UserDataData) {
	o.Data = v
}
