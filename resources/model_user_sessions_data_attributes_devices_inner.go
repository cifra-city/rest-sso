...
// checks if the UserSessionsDataAttributesDevicesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSessionsDataAttributesDevicesInner{}

// UserSessionsDataAttributesDevicesInner struct for UserSessionsDataAttributesDevicesInner
type UserSessionsDataAttributesDevicesInner struct {
	// session id
	Id string `json:"id"`
	// device name
...
type _UserSessionsDataAttributesDevicesInner UserSessionsDataAttributesDevicesInner
...
func NewUserSessionsDataAttributesDevicesInner(id string, deviceName string, client string, location string, lastUsed time.Time) *UserSessionsDataAttributesDevicesInner {
	this := UserSessionsDataAttributesDevicesInner{}
	this.Id = id
...
func (o UserSessionsDataAttributesDevicesInner) MarshalJSON() ([]byte, error) {
...
func (o UserSessionsDataAttributesDevicesInner) ToMap() (map[string]interface{}, error) {
...
func (o *UserSessionsDataAttributesDevicesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUserSessionsDataAttributesDevicesInner := _UserSessionsDataAttributesDevicesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserSessionsDataAttributesDevicesInner)

	if err != nil {
		return err
	}

	*o = UserSessionsDataAttributesDevicesInner(varUserSessionsDataAttributesDevicesInner)

	return err
}

type NullableUserSessionsDataAttributesDevicesInner struct {
	value *UserSessionsDataAttributesDevicesInner
	isSet bool
}

func (v NullableUserSessionsDataAttributesDevicesInner) Get() *UserSessionsDataAttributesDevicesInner {
	return v.value
}

func (v *NullableUserSessionsDataAttributesDevicesInner) Set(val *UserSessionsDataAttributesDevicesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSessionsDataAttributesDevicesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSessionsDataAttributesDevicesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSessionsDataAttributesDevicesInner(val *UserSessionsDataAttributesDevicesInner) *NullableUserSessionsDataAttributesDevicesInner {
	return &NullableUserSessionsDataAttributesDevicesInner{value: val, isSet: true}
}

func (v NullableUserSessionsDataAttributesDevicesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSessionsDataAttributesDevicesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
